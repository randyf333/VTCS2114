    ...
    implements BinarySearchTree<T>
{
    ...
    private BinaryNode<T> remove(T x, BinaryNode<T> node)
    {
        ...
        else
        {
            ...
            {
                T successor = elementAt(findMin(node.getRight()));
                result = remove(successor, result);
                result.setElement(successor);
            }
    ...
    /**
     * Gets an in-order string representation of the tree If the tree holds 5 /
     * \ 2 6 \ 3 It would print (2, 3, 5, 6)
     * 
